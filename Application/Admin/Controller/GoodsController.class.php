...
class GoodsController extends AdminController {
    ...
    /* 保存允许访问的公共方法 */
    static protected $allow = array( 'draftbox','mydocument','getMenu','index');

    private $cate_id        =   null; //文档分类id
    static protected $save_cate = array();
...
//        $cate           =   list_to_tree($cate);    //生成分类树
        $cate           =   list_to_tree(self::$save_cate);    //生成分类树
